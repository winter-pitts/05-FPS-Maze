...
var max_speed = 15									# velocity multiplier applied to every movement
var mouse_sensitivity = 0.010						# translating the mouse XY coordinates into angular (radian) movement
var mouse_range = 1.4								# Clamp to about a 140 degree range of motion
